...
**Quantitative Finance Engineer | Commodity Trading Enthusiast | Python Developer**
...
[![Location](https://img.shields.io/badge/Paris-France-red?style=for-the-badge&logo=googlemaps&logoColor=white)](#)
...
### 🏆 [Commodity Trading System](https://github.com/YOUR_USERNAME/commodity-trading-system)
...
### ⚓ [Freight Analytics Platform](https://github.com/YOUR_USERNAME/freight-analytics)
...
### 🚢 [Tankers Tracker](https://github.com/YOUR_USERNAME/tankers-tracker)
**Real-Time Vessel Tracking with AIS Data**

Live tanker monitoring application for maritime logistics:
- 🌍 **Interactive map visualization** of global tanker positions
- 📡 **AIS data integration** for real-time updates
- 🗺️ **Multi-region support** for trade route analysis
- ⚙️ **Automated refresh** for continuous monitoring

**Tech:** Python, AIS Stream, Interactive Maps
...
**Financial Markets**  
Commodity Trading • Energy Markets • Fixed Income • Derivatives Pricing • Portfolio Optimization

**Quantitative Methods**  
Machine Learning (XGBoost, Random Forest) • Stochastic Calculus • Black-Litterman • Risk Management (VaR, Stress Testing) • Time Series Analysis

**Trading Systems**  
Algorithmic Trading • Backtesting Frameworks • Real-Time Data Processing • Signal Generation • Performance Attribution

---

## 🚴 Beyond the Code

When I'm not building trading systems or analyzing markets, you'll find me:
...
- 📚 **Reading financial literature** and staying current with market developments
